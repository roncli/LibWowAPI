...
Namespace roncliProductions.LibWowAPI.Achievement
    ...
    Public Class Achievement
        ...
        Friend Sub New(intAchievementID As Integer, strTitle As String, intPoints As Integer, strDescription As String, strReward As String, ibiRewardItems As Collection(Of ItemBasicInfo), strIcon As String, cCriteria As Collection(Of Criteria), blnAccountWide As Boolean, fFaction As Faction)
