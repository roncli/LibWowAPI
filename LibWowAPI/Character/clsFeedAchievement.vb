...
Namespace roncliProductions.LibWowAPI.Character
    ...
    ''' <summary>
    ''' A class containing information about an achievement for the character feed.
    ''' </summary>
    ''' <remarks>This class provides detailed information about an achievement for the character feed.</remarks>
    Public Class FeedAchievement
        ...
        Private colCriteria As Collection(Of FeedCriteria)
        ''' <summary>
        ...
        ''' <remarks>This is a <see cref="Collection(Of FeedCriteria)" /> of <see cref="FeedCriteria" /> which represents a list of criteria required to complete the achievement.</remarks>
        Public ReadOnly Property Criteria As Collection(Of FeedCriteria)
            Get
                Return colCriteria
            End Get
        End Property

        Friend Sub New(intAchievementID As Integer, strTitle As String, intPoints As Integer, strDescription As String, strReward As String, ibiRewardItems As Collection(Of ItemBasicInfo), strIcon As String, cCriteria As Collection(Of FeedCriteria))
