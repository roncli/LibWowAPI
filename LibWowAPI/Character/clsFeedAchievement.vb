...
Namespace roncliProductions.LibWowAPI.Character
    ...
    Public Class FeedAchievement
        ...
        Friend Sub New(intID As Integer, strTitle As String, intPoints As Integer, strDescription As String, strReward As String, riRewardItems As Collection(Of RewardItem), strIcon As String, cCriteria As Collection(Of FeedCriteria))
            ID = intID
            Title = strTitle
            Points = intPoints
