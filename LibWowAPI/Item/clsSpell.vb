...
Namespace roncliProductions.LibWowAPI.Item
    ...
    Public Class Spell
        ...
        Friend Sub New(intID As Integer, strName As String, strRank As String, strIcon As String, strDescription As String, strRange As String, strPowerCost As String, strCastTime As String, strCooldown As String)
            ID = intID
            Name = strName
            Rank = strRank
            Icon = strIcon
