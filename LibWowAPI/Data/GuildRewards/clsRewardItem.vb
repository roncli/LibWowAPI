...
Namespace roncliProductions.LibWowAPI.Data.GuildRewards
    ...
    ''' <summary>
    ''' A class containing information about a guild reward item.
    ''' </summary>
    ''' <remarks>This class contains some of the information about an item received as a guild reward.</remarks>
